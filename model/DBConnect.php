...
class DBConnect{
	...
	public function __construct(){
		try{
			$this->connect = new PDO("mysql:host=localhost;dbname=restaurant", "root", "");
	...
	public function setStatement($option = []){ //mảng option dùng cho các query insert hay update, nó lưu data mình muốn insert vào để bindParam
