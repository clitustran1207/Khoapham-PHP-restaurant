              ...
              <div class="product-quanlity">
                <form action="#">
                  <div class="input-group">
                    <input type="text" name="quanlity" placeholder="" value="1" class="form-control txtSoluong"><a href="javascript:void(0)" class="quanlity-plus"><i class="fa fa-plus"></i></a><a href="javascript:void(0)" class="quanlity-minus"><i class="fa fa-minus"></i></a>
                  </div>
                  <div class="add-to-cart btnAddToCart" data-id="<?=$food->id?>">
                    <a href="javascript:void(0)" class="swin-btn"> <span>Add To Cart</span></a>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="products nav-slider">
            ...
            <div class="blog-item item swin-transition">
              <div class="block-img"><img src="public/assets/images/hinh_mon_an/<?=$same->image?>" style="height: 300px" alt="" class="img img-responsive">
                <div class="block-circle price-wrapper"><span class="price woocommerce-Price-amount amount"><span class="price-symbol">VNĐ</span><?=number_format($same->price)?></span></div>
                <div class="group-btn">
                  <a href="javascript:void(0)" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a>
                  <a href="javascript:void(0)" class="swin-btn btn-add-to-card" data-id="<?=$same->id_url?>"><i class="fa fa-shopping-basket"></i></a>
                </div>
              </div>
              <div class="block-content">
                <h5 class="title"><a href="food_detail.php?id=<?=$same->id?>&alias=<?=$same->url?>"><?=$same->name?></a></h5>
              </div>
            </div>
            <?php } ?>
          </div>
